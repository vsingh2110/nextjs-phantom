...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Color changed from #259ae1 to #1a6fb3 for WCAG 4.5:1 contrast ratio with white text */}
      <div className="bg-[#1a6fb3] relative z-10 h-auto">
          ...
          <div className="flex flex-row w-full justify-center items-center gap-1 py-1">
            ...
            <ul className="flex flex-row w-full justify-center items-center gap-1 px-2">
              ...
              <li className="flex justify-around items-center pt-2">
                <a className="text-lg p-1 text-white mr-1 hover:bg-white hover:text-[#1a6fb3] rounded" 
        ...
        <div className="hidden md:flex max-w-screen-xl w-[90%] mx-auto justify-between items-center py-1 md:py-2">
          <ul className="flex flex-row flex-wrap justify-left items-center list-none m-0 p-0 h-auto w-auto gap-2 md:gap-2">
            {/* Twitter */}
            <li className="flex justify-around items-center pt-2">
              <a className="text-sm p-1 text-white mr-2 hover:bg-white hover:text-[#1a6fb3] rounded md:text-base md:p-1 md:mr-2 md:hover:bg-white md:hover:text-[#1a6fb3]" 
                 href="https://twitter.com/Phantomhealthc" target="_blank" aria-label="Twitter">
                <i className="fa fa-twitter fa-fw" title="Twitter"></i>
              </a>
            </li>
            {/* Whatsapp */}
            <li className="flex justify-around items-center pt-2">
              <a className="text-sm p-1 text-white mr-2 hover:bg-white hover:text-[#1a6fb3] rounded" 
                 href="https://wa.me/+919899963601" target="_blank" aria-label="Whatsapp">
                <i className="fa fa-whatsapp fa-fw" title="Whatsapp"></i>
              </a>
            </li>
      ...
      */}
      <nav className="shadow-[0px_5px_10px_0px_#aaa] w-full bg-white text-black opacity-90 z-20 relative">
        <div className="flex h-16 items-center max-w-screen-xl w-[90%] mx-auto px-4">
          ...
          <div className="hidden md:flex md:justify-between md:items-center md:w-full">
            ...
            <Link href="/" className="text-black no-underline font-semibold text-sm md:text-base transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-3 py-2 rounded-lg">
              Home
            </Link>
            <Link href="/about" className="text-black no-underline font-semibold text-sm md:text-base transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-3 py-2 rounded-lg">
              About Us
            </Link>
            
            {/* Products Dropdown (from static: .dropdown, .submenu) */}
            <div className="relative group">
              <a href="#" className="text-black no-underline font-semibold text-sm md:text-base transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-3 py-2 rounded-lg flex items-center">
                Products
                ...
                <div className="relative group/mri">
                  ...
                  <div className="hidden group-hover/mri:block absolute left-full top-0 bg-white text-black min-w-[150px] p-3 text-sm leading-6 font-light ml-0 rounded-lg shadow-lg border z-20">
                    <div className="mb-2 mt-1 pl-2 pr-2 font-light">
                      <Link href="/product-pages/refurbished-ge-mri-scanner-machines" className="text-black no-underline hover:text-[#1a6fb3] block py-1">GE MRI</Link>
                    </div>
                    <div className="mb-2 mt-1 pl-2 pr-2 font-light">
                      <Link href="/product-pages/refurbished-siemens-mri-scanner-machines" className="text-black no-underline hover:text-[#1a6fb3] block py-1">Siemens MRI</Link>
                    </div>
                  </div>
                </div>
                <hr />
                <p className="mb-2 mt-2 pl-3 pr-3 font-light">
                  <Link href="/product-pages/refurbished-ct-scan-machines" className="text-black no-underline hover:text-[#1a6fb3] block py-1">CT Scanner</Link>
                </p>
                <hr />
                <p className="mb-2 mt-2 pl-3 pr-3 font-light">
                  <Link href="/product-pages/refurbished-pet-ct-scanner-machines" className="text-black no-underline hover:text-[#1a6fb3] block py-1">PET-CT Scanner</Link>
                </p>
                <hr />
                <p className="mb-2 mt-2 pl-3 pr-3 font-light">
                  <Link href="/product-pages/refurbished-cath-lab-machines" className="text-black no-underline hover:text-[#1a6fb3] block py-1">Cath-Lab</Link>
                </p>
                <hr />
                <p className="mb-2 mt-2 pl-3 pr-3 font-light">
                  <Link href="/product-pages/refurbished-gamma-camera-spect-system-machine" className="text-black no-underline hover:text-[#1a6fb3] block py-1">Gamma Camera-SPECT</Link>
                </p>
                <hr />
                <p className="mb-2 mt-2 pl-3 pr-3 font-light">
                  <Link href="/product-pages/refurbished-bone-densitometer-dexa" className="text-black no-underline hover:text-[#1a6fb3] block py-1">Bone Desnsitometer-DEXA</Link>
                </p>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="hidden group-hover:block absolute bg-white text-black min-w-[200px] p-4 text-sm leading-6 font-light left-0 top-full z-10 rounded-b-lg shadow-lg border">
                <p className="mb-2 mt-2 pl-3 pr-3 font-light">
                  <Link href="/services#service-packages" className="text-black no-underline hover:text-[#1a6fb3] block py-1">Service Packages</Link>
                </p>
                <hr />
                <p className="mb-2 mt-2 pl-3 pr-3 font-light">
                  <Link href="/services#repairs-and-upgrdaes" className="text-black no-underline hover:text-[#1a6fb3] block py-1">Repairs and Upgrades</Link>
                </p>
                <hr />
                <p className="mb-2 mt-2 pl-3 pr-3 font-light">
                  <Link href="/spare-parts-and-inventory" className="text-black no-underline hover:text-[#1a6fb3] block py-1">Spare Parts and Inventory</Link>
                </p>
              </div>
            </div>

            <Link href="/blogs" className="text-black no-underline font-semibold text-sm md:text-base transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-3 py-2 rounded-lg">
              Blogs
            </Link>
            <Link href="/contact" className="text-black no-underline font-semibold text-sm md:text-base transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-3 py-2 rounded-lg">
              Contact
            </Link>
          </div>
        </div>
        ...
        <ul className={`absolute top-full left-0 w-full bg-white shadow-lg md:hidden ${isMenuOpen ? 'block' : 'hidden'} z-50`}>
          <li className="block">
            <Link href="/" className="block text-black no-underline font-semibold text-base md:text-lg transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-4 py-3 rounded-lg">
              Home
            </Link>
          </li>
          <li className="block">
            <Link href="/about" className="block text-black no-underline font-semibold text-base md:text-lg transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-4 py-3 rounded-lg">
              About Us
            </Link>
          </li>
          ...
          <li className="relative block">
            <button 
              ...
              className="w-full text-left text-black no-underline font-semibold text-base md:text-lg transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-4 py-3 rounded-lg flex justify-between items-center"
            >
              Products
          ...
          <li className="block">
            <Link href="/blogs" className="block text-black no-underline font-semibold text-base md:text-lg transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-4 py-3 rounded-lg">
              Blogs
            </Link>
          </li>
          <li className="block">
            <Link href="/contact" className="block text-black no-underline font-semibold text-base md:text-lg transition-colors duration-300 ease-in-out hover:text-white hover:bg-[#1a6fb3] px-4 py-3 rounded-lg">
              Contact
            </Link>
          </li>
        </ul>
      ...
      <div className="fixed bottom-8 left-1 md:left-4 z-30 bg-[#59913d] w-14 h-14 md:w-16 md:h-16 rounded-full text-center text-xl md:text-2xl text-white hover:bg-[#1e4909] shadow-lg flex items-center justify-center">
        <a 
          ...
          className="text-white no-underline flex items-center justify-center w-full h-full"
