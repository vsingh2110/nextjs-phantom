      ...
      <section className="hero-side w-full h-auto lg:h-full z-20 flex items-start justify-center lg:justify-center p-1 lg:p-2">
        <div className="hero-side-warpper bg-white bg-opacity-95 backdrop-blur-sm rounded-lg p-2 lg:p-3 w-full lg:max-w-sm space-y-2 lg:space-y-3 shadow-xl">
          ...
          <div className="buy-online text-center p-2 lg:p-3 bg-gradient-to-r from-primary-50 to-primary-100 rounded-lg">
            ...
            <p className="text-xs lg:text-base text-gray-600 mb-2 leading-tight">
          ...
          <div className="sell-to-us text-center p-2 lg:p-3 bg-gradient-to-r from-secondary-50 to-secondary-100 rounded-lg">
            <h2 className="text-sm lg:text-xl font-bold text-secondary-700 mb-1">Sell To Us</h2>
            <p className="text-xs lg:text-base text-gray-600 mb-2 leading-tight">
          ...
          <div className="hero-call-us text-center p-2 lg:p-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
            <h2 className="text-sm lg:text-xl font-bold text-gray-700 mb-1">For Enquiries</h2>
            <button>
              <Link 
