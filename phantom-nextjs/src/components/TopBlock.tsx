      ...
      <div className="w-full max-w-[95%] 2xl:max-w-[1800px] mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 lg:gap-8 xl:gap-10 justify-center items-stretch mb-8">
          ...
          <div className="flex-1 bg-white rounded-3xl shadow-[0_0_25px_rgba(0,0,0,0.2)] p-6 md:p-8 flex flex-col items-center text-center antialiased border border-gray-100 min-w-0 hover:scale-110 hover:shadow-[0_0_45px_rgba(0,0,0,0.3)] transition-all duration-300">
            <Image src="/images/icons.png" alt="Buy/Sell MRI Machines, CT Scanner, PET-CT, Cath-Lab Machines" width={0} height={0} sizes="100vw" className="mb-6 w-28 h-28 md:w-32 md:h-32 object-contain" unoptimized />
          ...
          <div className="flex-1 bg-white rounded-3xl shadow-[0_0_25px_rgba(0,0,0,0.2)] p-6 md:p-8 flex flex-col items-center text-center antialiased border border-gray-100 min-w-0 hover:scale-110 hover:shadow-[0_0_45px_rgba(0,0,0,0.3)] transition-all duration-300">
            <Image src="/images/upd.png" alt="Inventory of Spare Parts also Available" width={0} height={0} sizes="100vw" className="mb-6 w-28 h-28 md:w-32 md:h-32 object-contain" unoptimized />
          ...
          <div className="flex-1 bg-white rounded-3xl shadow-[0_0_25px_rgba(0,0,0,0.2)] p-6 md:p-8 flex flex-col items-center text-center antialiased border border-gray-100 min-w-0 hover:scale-110 hover:shadow-[0_0_45px_rgba(0,0,0,0.3)] transition-all duration-300">
            <Image src="/images/ser.png" alt="Services and Repairs for Your Equipment" width={0} height={0} sizes="100vw" className="mb-6 w-28 h-28 md:w-32 md:h-32 object-contain" unoptimized />
