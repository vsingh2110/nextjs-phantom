  ...
  return (
    <>
      ...
      <section className="hero-side w-full h-auto lg:h-auto max-h-full z-20 flex items-center justify-center p-0 lg:p-2 mt-4 lg:mt-0">
        <div className="hero-side-warpper bg-white bg-opacity-95 backdrop-blur-sm rounded-none lg:rounded-2xl p-0 lg:p-3 w-full lg:w-[300px] xl:w-full space-y-0 lg:space-y-3 shadow-none lg:shadow-2xl max-h-full overflow-y-auto">
