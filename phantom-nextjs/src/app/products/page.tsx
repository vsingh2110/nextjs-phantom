    ...
    <main className="main-content">
        ...
        <div className="container">
          ...
          <div className="products-grid">
            <div className="product-card">
              <img src="/images/machines/1.5t-mri/GE Signa 1.5T HDxt.jpg" alt="GE Signa 1.5T HDxt" />
            ...
            <div className="product-card">
              <img src="/images/machines/3.0t-mri/GE Signa 3.0T.jpg" alt="GE Signa 3.0T" />
              <h3>GE Signa 3.0T</h3>
              <p>High-field 3.0T MRI scanner for superior image quality and resolution.</p>
              <a href="/product-pages/refurbished-ge-mri-scanner-machines" className="btn btn-primary">Learn More</a>
            </div>
            <div className="product-card">
              <img src="/images/machines/3.0t-mri/Siemens Magnetom Skyra MRI.jpg" alt="Siemens Magnetom Skyra" />
      ...
      <section className="product-category">
        <div className="container">
          ...
          <div className="products-grid">
            <div className="product-card">
              <img src="/images/machines/ct-scan/GE revolution EVO.jpg" alt="GE Revolution EVO" />
            ...
            <div className="product-card">
              <img src="/images/machines/ct-scan/brightspeed.jpg" alt="GE BrightSpeed" />
              <h3>GE BrightSpeed</h3>
              <p>High-performance CT scanner for accurate diagnostic imaging.</p>
              <a href="/product-pages/refurbished-ct-scan-machines" className="btn btn-primary">Learn More</a>
            </div>
            <div className="product-card">
              <img src="/images/machines/ct-scan/Siemens Go Now CT Scanner.jpg" alt="Siemens Go Now" />
      ...
      <section className="product-category">
        <div className="container">
          ...
          <div className="products-grid">
            <div className="product-card">
              <img src="/images/machines/allura.png" alt="Philips Allura" />
      ...
      <section className="product-category">
        <div className="container">
          ...
          <div className="products-grid">
            <div className="product-card">
              <img src="/images/machines/gamma camera spect/GE infinia gamma camera SPECT.jpg" alt="GE Infinia Gamma Camera" />
      ...
      <section className="product-category">
        <div className="container">
          ...
          <div className="products-grid">
            <div className="product-card">
              <img src="/images/machines/Dexa Bone Densitometer.jpg" alt="DEXA Bone Densitometer" />
