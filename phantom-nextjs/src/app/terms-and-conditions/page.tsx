      ...
      <section className="py-12">
        <div className="container mx-auto w-[90%] max-w-7xl">
          <div className="space-y-6">
            {/* 
              NOTE: The content below is migrated from the original website's terms-and-conditions.html.
              The original file contained Privacy Policy content instead of Terms and Conditions.
              This has been preserved to match the source, but should be updated with correct legal text.
            */}
            <div>
