 ...
 * =================
 * 
 * Phantom Healthcare India Headquarters - Faridabad, Haryana
 */
...
export const metadata: Metadata = {
  title: 'Delhi/Faridabad Office - Phantom Healthcare India Headquarters',
  description: 'Phantom Healthcare India headquarters in Faridabad, Haryana. Contact us for medical imaging equipment, service, and support in India and Sub-Continent.',
  openGraph: {
    title: 'Delhi Office - Phantom Healthcare',
    description: 'India headquarters in Faridabad. Contact: +91 9899963601',
    url: 'https://phantomhealthcare.com/our-offices/delhi',
  },
  alternates: {
    canonical: 'https://phantomhealthcare.com/our-offices/delhi',
  },
};
...
export default function DelhiOfficePage() {
  const localBusinessData = {
    ...
    "name": "Phantom Healthcare IND Private Limited - India Headquarters",
    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: 'Delhi Office', url: 'https://phantomhealthcare.com/our-offices/delhi' },
        ]}
      />
      ...
      <main className="min-h-screen">
        ...
        <section className="relative h-[250px] sm:h-[300px] md:h-[350px] bg-gradient-to-r from-orange-500 via-white to-green-600 flex items-center justify-center">
          ...
          <div className="relative z-10 text-center px-4">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-2">India Headquarters</h1>
            <p className="text-lg sm:text-xl text-gray-700 font-semibold">Faridabad, Haryana</p>
          </div>
        </section>
          ...
          <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav className="mb-6">
              <ol className="flex flex-wrap items-center gap-2 text-sm text-gray-600">
                ...
                <li>/</li>
                <li className="text-gray-900 font-semibold">Delhi Office</li>
              </ol>
            </nav>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 md:p-10 mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                Phantom Healthcare IND Pvt Ltd
              </h2>
              ...
              <div className="mb-6">
                ...
                <div className="pl-7 space-y-2 text-gray-700">
                  ...
                  <p><a href="tel:+911294312423" className="hover:text-primary-600">+91 129 4312423</a></p>
                  <p><a href="tel:+918545815483" className="hover:text-primary-600">+91 8545815483</a></p>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="w-full h-[400px] rounded-lg overflow-hidden shadow-lg">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3508.5!2d77.3178!3d28.4089!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDI0JzMyLjAiTiA3N8KwMTknMDQuMSJF!5e0!3m2!1sen!2sin!4v1234567890"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Phantom Healthcare India Office Location"
                  ></iframe>
                </div>
              </div>
